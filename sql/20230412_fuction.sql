...
select ename, sal, to_char(sal*1300, '999,999,999') as wonSAL
from emp;
...
-- 그룹(=집합, 집계, 다중행) 함수
-- 하나의 행이 아닌 다중행을 그룹으로 묶어서 처리 ~ where를 통해서 행을 조절 할 수 있음
-- sun, avg, count(row의 개수를 셈), max, min, 
